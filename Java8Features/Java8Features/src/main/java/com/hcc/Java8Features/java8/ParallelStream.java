...
public class ParallelStream {
	...
	public static void main(String[] args) {
		...
		List<String>ls=Arrays.asList("sam","sammy","Samiksha");
		Optional<String> w=ls.stream().reduce((a,b)->a.length()>b.length()?a:b);
		...
		lstSort.stream().sorted(Comparator.reverseOrder()).collect(Collectors.toList());//Decending order
