...
public class LogicalProgram {
	...
	public static boolean vowelPresentCheck(String s2){
		boolean s = IntStream.rangeClosed(0,s2.length()).mapToObj(s2::charAt).anyMatch(k->"aeiouAEIOU".indexOf(k) >=0);
		return s;
	}
//
...
//	
//	int fact1=IntStream.rangeClosed(2, 7).reduce(1, (int t1, int t2)->t1*t2);
//	System.out.println("reduce result: "+fact1);
////}
